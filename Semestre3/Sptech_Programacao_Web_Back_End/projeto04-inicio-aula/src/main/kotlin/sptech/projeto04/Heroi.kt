...
class Heroi(
    ...
    constructor(heroidto: HeroiDTO) : this() {
        this.forca = heroidto.forca;
        this.apelido = heroidto.apelido;
        this.classe = heroidto.classe;
        this.dataAposentadoria = heroidto.dataAposentadoria
    }
